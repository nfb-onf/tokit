...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SpecificPathValidation'
        db.create_table('tokit_specificpathvalidation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('tokit', ['SpecificPathValidation'])

        # Adding model 'GlobalPathException'
        db.create_table('tokit_globalpathexception', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('tokit', ['GlobalPathException'])


    def backwards(self, orm):
        
        # Deleting model 'SpecificPathValidation'
        db.delete_table('tokit_specificpathvalidation')

        # Deleting model 'GlobalPathException'
        db.delete_table('tokit_globalpathexception')
    ...
    models = {
        ...
        'tokit.globalpathexception': {
            'Meta': {'object_name': 'GlobalPathException'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'tokit.specificpathvalidation': {
            'Meta': {'object_name': 'SpecificPathValidation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'tokit.token': {
            ...
            'permissions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['tokit.TokenPermission']", 'null': 'True', 'blank': 'True'}),
