...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        sql = 'INSERT INTO tokit_token (`key`,description,owner_id,is_internal,is_valid,date_created,last_modfied,request_per_day_limit,last_access) SELECT `key`,version_description,owner_id,is_internal,valid,date_created,last_modfied,request_per_day_limit,last_modfied FROM tube_api_key'
        db.execute(sql)
